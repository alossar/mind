...
public class PanelPruebas extends VLayout {

	private PanelContenidoPruebas panelContenidoTemas;
	...
	public PanelPruebas() {
		...
		panelContenidoTemas = new PanelContenidoPruebas();

		inicializarEncabezado();

		titulo.setContents("<h1>" + "Pruebas" + "</h1>");
	...
	public static void setEncabezadoPredeterminado() {
		titulo.setContents("<h1>" + "Pruebas" + "</h1>");
		subtitulo.setContents("Agrupe el contenido de sus evaluaciones");
		imagenLogo.setSrc("insumos/pruebas/logoTemas.png");
	}
