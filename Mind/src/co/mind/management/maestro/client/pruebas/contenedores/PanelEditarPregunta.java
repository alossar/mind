...
public class PanelEditarPregunta extends HLayout {
	...
	public PanelEditarPregunta(PanelContenidoPruebas panelCategorias,
		...
		botonNuevaPregunta = new ToolStripButton("Guardar Cambios",
	...
	private void mostrarInformacionPregunta() {
		panelPregunta.setPosicionPregunta(pregunta.getPosicionPreguntaX(),
				pregunta.getPosicionPreguntaY());
		panelPregunta.actualizarTiempo(pregunta.getTiempoMaximo());
		panelPregunta.cambiarTextoPregunta(pregunta.getPregunta());
		richTextEditorPregunta.setValue(pregunta.getPregunta());
		integerItemRespuestaMaxima.setValue(pregunta.getCaracteresMaximo());
		integerItemTiempoMaximo.setValue(pregunta.getTiempoMaximo());
		panelPregunta.cambiarImagen(pregunta.getImagenesUsuario().getImagen()
				.getImagenURI());
	}
