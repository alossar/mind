...
import co.mind.management.maestro.client.temas.PanelContenidoTemas;
...
public class PanelAgregarLaminas extends HLayout {
	...
	private PanelContenidoTemas panelPruebas;

	public PanelAgregarLaminas(PanelContenidoTemas panelCategorias) {
		...
		botonNuevaPregunta = new ToolStripButton("Agregar L\u00E1mina",
