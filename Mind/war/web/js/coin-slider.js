			...
			for (i = 1; i <= params[el.id].sph; i++) {
				...
				for (j = 1; j <= params[el.id].spw; j++) {
					...
					if (params[el.id].links) {
						$('#' + el.id).append("<a href='" + links[el.id][0] + "' class='cs-" + el.id + "' id='cs-" + el.id + i + j + "' style='width:" + 960 + "px; height:" + 570 + "px; float: left; position: absolute;'></a>");
					} else {
						$('#' + el.id).append("<div class='cs-" + el.id + "' id='cs-" + el.id + i + j + "' style='width:" + 960 + "px; height:" + 570 + "px; float: left; position: absolute;'></div>");
					}
